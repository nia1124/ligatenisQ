<div class="container">
	<div id="contenedorFooter" class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center">
		<div class="row col-md-12">
			<h3 align="center">CONTACTO</h3>
		</div>
		<div class="row">			
			<img src="recursos/img/movil.png" class="imgItemPanelFoter visible-md visible-lg"/>				
			<a href="#" target="_blank"> 312-235-4123 - 321-234-7654</a>
		</div>
		<div class="row">			
			<img src="recursos/img/email.png" class="imgItemPanelFoter visible-md visible-lg" />				
			<a href="#" target="_blank" float="left">ligatenisdemesaquindio@gmail.com</a>
		</div>	
		<div class="row">			
			<img src="recursos/img/ubicacion.png" class="imgItemPanelFoter visible-md visible-lg"/>				
		...
		<div class="row">			
			<img src="recursos/img/facebook.png" class="imgItemPanelFoter visible-md visible-lg" />				
			<a href="http://www.facebook.com" target="_blank" float="left">facebook/ligatenisdemesaquindio</a>
		</div>
		<div class="row margin-bottom" >			
			<img src="recursos/img/twitter.png" class="imgItemPanelFoter visible-md visible-lg" />				
